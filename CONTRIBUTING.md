We love that you’re interested in contributing to JRTPLib! Any contribution is more than welcome!
...
```bash
open JRTPLib.xcodeproj
```

## Pass Tests

In order to archive best quality, JRTPLib has a lot tests to pursue this goal. After changed the code, it's better to update the tests accordingly and have all tests passed with the following command:
